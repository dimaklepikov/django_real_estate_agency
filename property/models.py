...
class Owner(models.Model):
    ...
    owned_flats = models.ManyToManyField(Flat, related_name='flats_owned', verbose_name='Квартиры в собственности')

    def __str__(self):
        return f"{self.name}, {self.pure_phone_number} ({self.owned_flats})"
